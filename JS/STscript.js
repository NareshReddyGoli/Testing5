...
//display the score
// Display the score and redirect to the winning page
function displayScore() {
  let percentageAcc =
    wordsSubmitted !== 0
      ? Math.floor((wordsCorrect / wordsSubmitted) * 100)
      : 0;
  let wpm = factor * wordsCorrect;

  // Redirect to winning.html with score and accuracy as URL parameters
  window.location.href = `winning.html?wpm=${wpm}&accuracy=${percentageAcc}`;
}
